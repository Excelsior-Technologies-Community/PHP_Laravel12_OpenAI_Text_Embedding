            ...
            <div class="mb-8">
                ...
                <div class="bg-yellow-50 border-l-4 border-yellow-500 rounded-lg p-5">
                    <div class="flex items-start">
                        <i class="fas fa-flask text-yellow-600 text-2xl mr-4 mt-1"></i>
                        ...
                        <div>
                            ...
                            <p class="text-sm text-yellow-700 mt-2">
                                Similarity search is using mock embeddings because the OpenAI API is currently unavailable or rate-limited.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-green-700 mt-2">
                                Similarity search is using real OpenAI embeddings.
                            </p>
                        </div>
                    </div>
                </div>
