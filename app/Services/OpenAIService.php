...
class OpenAIService
{
    ...
    public function generateEmbedding(string $text): array
    {
        ...
        try {
            ...
            // Switch to Demo Mode if API key is invalid
            if (
                str_contains($errorMessage, 'Incorrect API key') ||
            ...
            // Any unexpected error → Demo Mode
            $this->useMock = true;
    ...
    private function generateMockEmbedding(string $text): array
    {
        ...
        return [
            'success' => true,
            'embedding' => $embedding,
            'model' => 'text-embedding-3-small (Demo Mode)',
            'usage' => [
